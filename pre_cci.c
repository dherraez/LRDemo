# 1 "c:\\users\\dherraez\\documents\\vugen\\scripts\\masterclass_book_flight\\\\combined_MasterClass_Book_Flight.c"
...
# 1 "c:\\users\\dherraez\\documents\\vugen\\scripts\\masterclass_book_flight\\\\combined_MasterClass_Book_Flight.c" 2
...
# 2 "c:\\users\\dherraez\\documents\\vugen\\scripts\\masterclass_book_flight\\\\combined_MasterClass_Book_Flight.c" 2
...
# 3 "c:\\users\\dherraez\\documents\\vugen\\scripts\\masterclass_book_flight\\\\combined_MasterClass_Book_Flight.c" 2
...
# 4 "c:\\users\\dherraez\\documents\\vugen\\scripts\\masterclass_book_flight\\\\combined_MasterClass_Book_Flight.c" 2
...
Book_Flight()
{
	...
	web_reg_find("SaveCount=Web_Tours_Count",
		"Text=Web Tours",
		"LAST");
	...
	lr_start_transaction("MasterClass_BookFlight_Launch_T01");
	...
	iCount = atoi(lr_eval_string("{Web_Tours_Count}"));
	
	if (iCount > 6){
		lr_end_transaction("MasterClass_BookFlight_Launch_T01", 0);
	}
	else {
		lr_end_transaction("MasterClass_BookFlight_Launch_T01", 1);
...
# 5 "c:\\users\\dherraez\\documents\\vugen\\scripts\\masterclass_book_flight\\\\combined_MasterClass_Book_Flight.c" 2
...
# 6 "c:\\users\\dherraez\\documents\\vugen\\scripts\\masterclass_book_flight\\\\combined_MasterClass_Book_Flight.c" 2
